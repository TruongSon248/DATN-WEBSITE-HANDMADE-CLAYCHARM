        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Chỉnh sửa Tác giả</h5>
                </div>
                    ...
                    <form action="{{ route('admin.authors.update', $author->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                name="name" value="{{ old('name', $author->name) }}" placeholder="Nhập tên tác giả">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('date') is-invalid @enderror" id="date"
                                name="date" value="{{ old('date', $author->date) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('address') is-invalid @enderror" id="address"
                                name="address" value="{{ old('address', $author->address) }}" placeholder="Nhập địa chỉ">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                rows="3" placeholder="Nhập mô tả">{{ old('description', $author->description) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('bio') is-invalid @enderror" id="bio" name="bio" rows="4"
                                placeholder="Nhập tiểu sử">{{ old('bio', $author->bio) }}</textarea>
